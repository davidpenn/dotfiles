...
# History
mkdir -p ${HOME}/.cache/$(hostname -s)/
HISTFILE=${HOME}/.cache/$(hostname -s)/zsh_history
HISTSIZE=50000000
SAVEHIST=$HISTSIZE
HISTDUP=erase
...
# Shell integrations
test -e ~/Library/Group\ Containers/2BUA8C4S2C.com.1password/t/agent.sock && export SSH_AUTH_SOCK=~/Library/Group\ Containers/2BUA8C4S2C.com.1password/t/agent.sock
